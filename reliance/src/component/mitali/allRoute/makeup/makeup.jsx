          ...
          <Card className='m-heading' bg={"whiteAlpha.900"}>
            <CardBody className='m-head'>
              ...
              <Box style={{ display: "flex" }}>
                <Text>Sort By : </Text>
                <Text className='text' onClick={asc}>
                  Price(Low-High){" "}
                </Text>
                <Text className='text' onClick={desc}>
                  Price(High-Low)
                </Text>
              </Box>
            </CardBody>
              ...
              {datas.map((post) => (
                <Card key={post.id} bg={"whiteAlpha.900"}>
                  ...
                  <Box style={{ height: "40%" }}>
                    ...
                    <Text style={{ display: "flex", marginLeft: "30%" }}>
