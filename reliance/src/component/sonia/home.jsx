  ...
  return (
    ...
    <Menubar/>
      ...
      >
        <div class='carousel-inner'>
          <div class='carousel-item active'>
            <Image
              src='https://www.reliancedigital.in/medias/Accessories-Fiesta-Carousel-Banner-D.jpg?context=bWFzdGVyfGltYWdlc3w5MTAwN3xpbWFnZS9qcGVnfGltYWdlcy9oY2MvaDI5Lzk5Mjk4MTAyMTQ5NDIuanBnfGUxYTc3MTMzNThhNzlkZGQyNTNlYTYxMzM3OWM4NzQzYjY2YWYwYzFkNjhhMjA5M2YwNDhiYTMwMzA2ZGY5MTY'
              class='d-block w-100'
              alt='...'
            />
          </div>
          {data.map((el) => (
            <div class='carousel-item'>
              <Image src={el} class='d-block w-100' alt='...' />
            </div>
          ))}
        </div>
        <button
      ...
      <Box w={"100%"}>
        ...
        <Box display={"flex"} gap='20px' justifyContent={"center"} pt={10}>
          {[
            ...
            <Image src={el} w={"23%"} justifySelf='center' />
          ))}
        </Box>
        <Stack mt='10px'>
          <Heading fontSize={{ sm: "20px", base: "12px", md: "24px" }} p='10px'>
            BIGGEST PRICE DROP ON ROOM HEATERS
          </Heading>
          <Stack p='10px'>
            <RoomHeater />
          </Stack>
        ...
        <Box w={"100%"} margin={"auto"}>
          ...
          >
            {[
              ...
              <Image src={el} w={"90%"} justifySelf='center' mt='35px' />
            ))}
          </Box>
        </Box>
      </Box>
      <Box>
        ...
        >
          <div class='carousel-inner'>
            <div class='carousel-item active'>
              <Image
                src='https://www.reliancedigital.in/medias/MIdnight-Sale-Carousel-07-12-2022.jpg?context=bWFzdGVyfGltYWdlc3w5OTA2OXxpbWFnZS9qcGVnfGltYWdlcy9oNzYvaGM5Lzk5MjgzODQ4Mzk3MTAuanBnfGUxZTBiNDNlOGU2ZWUzMzg2YjU3MWMwYmJiNTBhZjM5ODdkMzhjYjNiYWZhYzllYWJmNzE0MGY4MTFmMjY3MDU'
                class='d-block w-100'
                alt='...'
              />
            </div>
      ...
      <Box>
        <Heading
          p='10px'
          fontSize={{ sm: "10px", base: "12px", md: "18px" }}
          color='blue.700'
          textAlign='center'
        >
        ...
        <Box display={"flex"} gap='20px' justifyContent={"center"} pt={10}>
          {[
            ...
            >
              ...
              <Heading
                color='blue.700'
                fontSize={{ sm: "10px", base: "9px", md: "13px" }}
              >
                {el.h}
              </Heading>
              <Heading fontSize={{ sm: "6px", base: "9px", md: "12px" }}>
                {el.p}
              </Heading>
            </Box>
          ))}
      ...
      <Stack mt='30px'>
        <Heading fontSize='22px' p='10px'>
          UP TO 80% OFF ON PERSONAL CARE APPLIANCES
        </Heading>
        ...
        <Box width='100%' display='flex' p='10px'>
          ...
          <Box width='30%'>
            <Image
              src='https://www.reliancedigital.in/medias/Best-of-Monitors-Producst-Carousel-27-Personal-care-appliances-02.jpg?context=bWFzdGVyfGltYWdlc3w1MDYxN3xpbWFnZS9qcGVnfGltYWdlcy9oNTcvaDU1Lzk5MjkyMTYxNjM4NzAuanBnfDU2YWUyODU2M2UxNTZiM2ZkZDgyNDBiNDliN2I1YmVkYmQwYWQ1YmMzY2NmOWNhYjQyMDI2ODY1ZGMzYWVkOGQ'
              w='100%'
              mt='10px'
              mb='10px'
            />
